...
<body class="bg-white dark:bg-linear-to-b dark:from-neutral-950 dark:to-neutral-900 min-h-screen antialiased">
    <div
        class="relative flex-col justify-center items-center grid lg:grid-cols-2 px-8 sm:px-0 lg:px-0 lg:max-w-none h-dvh">
        <div
            class="hidden relative lg:flex flex-col bg-muted p-10 dark:border-e dark:border-neutral-800 h-full text-white">
        ...
        <div class="lg:p-8 w-full">
            <div class="flex flex-col justify-center space-y-6 mx-auto w-full sm:w-[350px]">
                <a href="{{ route('home') }}" class="lg:hidden z-20 flex flex-col items-center gap-2 font-medium"
                    wire:navigate>
