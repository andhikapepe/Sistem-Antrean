...
<head>
    ...
    @if (!empty($appSettings['app_logo']))
        ...
        {{-- Jika Anda ingin mendukung SVG secara khusus, bisa dicek ekstensinya --}}
        @if (str_ends_with($appSettings['app_logo'], '.svg'))
            <link rel="icon" href="{{ asset('storage/' . $appSettings['app_logo']) }}" type="image/svg+xml">
        @endif
    @else
...
<body
    ...
    <div
        ...
        <main class="flex lg:flex-row flex-col-reverse w-full max-w-[335px] lg:max-w-4xl">
            <div
                class="flex-1 bg-white dark:bg-[#161615] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] p-6 lg:p-20 pb-12 lg:rounded-ss-lg rounded-ee-lg lg:rounded-ee-none rounded-es-lg text-[13px] dark:text-[#EDEDEC] leading-[20px]">
                ...
                <ul class="flex flex-col mb-4 lg:mb-6">
                    <li
                        ...
                        <span>
                            ...
                            <a href="https://laravel.com/docs" target="_blank"
                                class="inline-flex items-center space-x-1 ms-1 font-medium text-[#f53003] dark:text-[#FF4433] underline underline-offset-4">
                    ...
                    <li
                        class="before:top-0 before:bottom-1/2 before:absolute relative flex items-center gap-4 py-2 before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:border-l before:start-[0.4rem]">
                        <span class="relative bg-white dark:bg-[#161615] py-1">
                            <span
                                class="flex justify-center items-center bg-[#FDFDFC] dark:bg-[#161615] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-full w-3.5 h-3.5">
                                <span class="bg-[#dbdbd7] dark:bg-[#3E3E3A] rounded-full w-1.5 h-1.5"></span>
            ...
            <div
                class="relative bg-[#fff2f2] dark:bg-[#1D0002] lg:-ms-px -mb-px lg:mb-0 lg:rounded-e-lg! rounded-t-lg lg:rounded-t-none w-full lg:w-[438px] aspect-[335/376] lg:aspect-auto overflow-hidden shrink-0">
                {{-- Laravel Logo --}}
                ...
                {{-- Light Mode 12 SVG --}}
                <svg class="dark:hidden relative -ms-8 lg:ms-0 -mt-[4.9rem] lg:-mt-[6.6rem] w-[448px] max-w-none"
                ...
                {{-- Dark Mode 12 SVG --}}
                <svg class="hidden dark:block relative -ms-8 lg:ms-0 -mt-[4.9rem] lg:-mt-[6.6rem] w-[448px] max-w-none"
                    viewBox="0 0 440 376" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g
                        class="opacity-100 starting:opacity-0 transition-all translate-y-0 starting:translate-y-4 duration-750 delay-300">
                        <path
                ...
                <div
                    class="absolute inset-0 shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] lg:rounded-e-lg rounded-t-lg lg:rounded-t-none">
                </div>
            </div>
        </main>
    </div>
